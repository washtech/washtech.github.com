...
<p><h5><i class="icon-tag "></i>&nbsp;Description of Services</h5></p>
<p>We make various services available on this site including, but not limited to,  hosting and storage of text, files, and/or data, and other like services. You are responsible for providing, at your own expense, all equipment necessary to use the services, including a computer, modem, and Internet access (including payment of all fees associated with such access).</p>
...
<h5><i class="icon-tag "></i>&nbsp;Disclaimer of Warranties</h5></p>
...
<p><h5><i class="icon-tag "></i>&nbsp;Limitation of Liability</h5></p>
...
<p><h5><i class="icon-tag "></i>&nbsp;Indemnification</h5></p>
...
<p><h5><i class="icon-tag "></i>&nbsp;Security and Password</h5></p>
...
<p><h5><i class="icon-tag "></i>&nbsp;Participation in Promotions</h5></p>
...
<p><h5><i class="icon-tag "></i>&nbsp;E-mail, Messaging, Blogging, and Chat Services</h5></p>
...
<p><h5><i class="icon-tag "></i>&nbsp;International Use</h5></p>
...
<p><h5><i class="icon-tag "></i>&nbsp;Termination of Use</h5></p>
...
<p><h5><i class="icon-tag "></i>&nbsp;Miscellaneous</h5></p>
...
<p>Any failure by us to enforce or exercise any provision of these Terms of Use or related rights shall not constitute a waiver of that right or provision.</p>
		...
		<div class="span3">
		<img src="img/terms-of-use.jpg"  alt="">
                </div>
	</div>
	</div>
	<?
